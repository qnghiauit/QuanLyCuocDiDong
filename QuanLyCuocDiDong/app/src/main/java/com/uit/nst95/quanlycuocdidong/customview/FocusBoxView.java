...
/**
 * Custom view - Focus box view when user launch camera to capture the portal card.
...
public class FocusBoxView extends View {
    ...
    private Rect box; // the primary box
    ...
    private Rect getBoxRect() {
        ...
        if (box == null) {
            ...
            // get device's screen resolution via the utility class
